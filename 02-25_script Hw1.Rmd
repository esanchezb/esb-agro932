...
gff <- fread(cmd='grep -v "#" Phaseolus_vulgaris.PhaVulg1_0.46.gff3', header=FALSE, data.table=FALSE)
...
up5k <- data.table("../esb-agro932/cache/mt_gene_up5k.txt", header=TRUE) # Putty
